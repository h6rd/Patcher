...
if !hash_exists! equ 1 (
  echo [SUCCESS] Signature Already Exists
) else (
  >>"!s_fl!" (
    echo(
    echo !f_s!
  )
  echo [SUCCESS] Signature Added
)
set "gi_path="
...
set "src1=%~dp0game\Dota2SkinChanger\pak02_dir.vpk"
set "src2=%~dp0..\game\Dota2SkinChanger\pak02_dir.vpk"
set "src3=%USERPROFILE%\Downloads\game\Dota2SkinChanger\pak02_dir.vpk"
set "src4=%~dp0pak02_dir.vpk"
set "src5=!gP!\pak02_dir.vpk"
set "src6=%~dp0..\pak02_dir.vpk"
set "src7=%USERPROFILE%\Downloads\pak02_dir.vpk"

set "dest=!gP!\game\!fon!\pak02_dir.vpk"
set "found_pak=0"
if exist "!src1!" (
